...
This workflow checks a sheet for empty script cells every hour and triggers AI generation to fill them.
...
2. **HTTP Request — Get sheet**

   Fetch the sheet to find rows that need scripts.
