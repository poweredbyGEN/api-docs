...
## Real-Time Progress (Firebase)

The `firebase_path` from the run response points to a Firebase RTDB path. Subscribe for real-time updates:
...
<Aside>
Firebase streaming is publicly readable — no authentication needed to subscribe.
</Aside>
