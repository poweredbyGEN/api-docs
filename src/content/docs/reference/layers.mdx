...
```
POST /v1/vidsheet/{id}/cells/{cell_id}/layers/{layer_id}/duplicate?agent_id={agent_id}
```
...
```bash
curl -X POST "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/4000/duplicate?agent_id=42" \
  -H "X-API-Key: your-api-key"
```
