...
```
POST /v1/vidsheet/{id}/cells/{cell_id}/layers?agent_id={agent_id}
```
...
```bash
curl -X POST "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers?agent_id=42" \
...
```
GET /v1/vidsheet/{id}/cells/{cell_id}/layers/{layer_id}?agent_id={agent_id}
```
...
```bash
curl "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/4000?agent_id=42" \
  -H "X-API-Key: your-api-key"
```
...
```
PATCH /v1/vidsheet/{id}/cells/{cell_id}/layers/{layer_id}?agent_id={agent_id}
```
...
```bash
curl -X PATCH "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/4000?agent_id=42" \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
...
```bash
curl -X PATCH "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/4001?agent_id=42" \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
...
```bash
curl -X PATCH "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/4002?agent_id=42" \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
...
```
DELETE /v1/vidsheet/{id}/cells/{cell_id}/layers/{layer_id}?agent_id={agent_id}
```
...
```bash
curl -X DELETE "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/4000?agent_id=42" \
  -H "X-API-Key: your-api-key"
```
...
Use `gen_vidsheet_discover`, then call `gen_vidsheet_action` with
`action: "duplicate"` and `target.kind: "layer"`.
See [Work with a Vidsheet](/guides/vidsheet-actions/) for the current schema.
...
```
PUT /v1/vidsheet/{id}/cells/{cell_id}/layers/update_positions?agent_id={agent_id}
```
...
```bash
curl -X PUT "https://api.gen.pro/v1/vidsheet/101/cells/3000/layers/update_positions?agent_id=42" \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
