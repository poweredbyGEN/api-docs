...
For programmatic asks where you'd rather build a typed parameter object than a natural-language prompt, the MCP server ships a `gen_query_watchlist` tool that wraps the chat path with structured fields.
