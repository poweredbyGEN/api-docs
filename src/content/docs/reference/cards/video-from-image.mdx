...
| Seedance 2.0 | `video_from_image` | `"seedance-2.0"` |
| Grok | `video_from_image` | `"grok"` |
...
|-------|------|-------------|
| `model` | string | Default model: `"kling_2_1"`, `"kling_2_6"`, `"veo_3"`, `"veo_3_1"`, `"sora_2"`, `"seedance_lite"`, `"seedance_pro"`, `"grok"`, etc. |
