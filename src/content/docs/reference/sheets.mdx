...
description: Create, read, rename, and delete Auto Content Engines — the top-level workspace for video content.
---
...
Permanently deletes an Auto Content Engine together with all of its columns, rows, cells, layers, global variables, and automations. This cannot be undone. Rendered output resources are detached, not deleted (see [Download](/step-5-export/download/)).
