...
| GET | /v1/user_voice_resources?agent_id= | setup |
...
| Method | Path | Phase |
|--------|------|-------|
| POST | /v1/vidsheet | convert |
| GET | /v1/vidsheet/:id | convert |
| POST | /v1/vidsheet/:id/clone | convert |
| GET | /v1/vidsheet/:id/operations | edit |
| GET | /v1/vidsheet/:id/operations/last | edit |
| POST | /v1/vidsheet/:id/operations/undo | edit |
| POST | /v1/vidsheet/:id/operations/redo | edit |

## Rows

| Method | Path | Phase |
|--------|------|-------|
| GET | /v1/vidsheet/:id/rows | edit |
| POST | /v1/vidsheet/:id/rows | edit |
| GET | /v1/vidsheet/:id/rows/:row_id | edit |
| POST | /v1/vidsheet/:id/rows/:row_id/duplicate | edit |
| PUT | /v1/vidsheet/:id/rows/update_positions | edit |
| PUT | /v1/vidsheet/:id/rows/mass_update | edit |

## Columns

| Method | Path | Phase |
|--------|------|-------|
| GET | /v1/vidsheet/:id/columns | edit |
| POST | /v1/vidsheet/:id/columns | edit |
| POST | /v1/vidsheet/:id/columns/:col_id/duplicate | edit |
| PATCH | /v1/vidsheet/:id/columns/update_positions | edit |
| PUT | /v1/vidsheet/:id/columns/mass_update | edit |

## Cells

| Method | Path | Phase |
|--------|------|-------|
| GET | /v1/vidsheet/:id/cells/:cell_id | edit |
| PATCH | /v1/vidsheet/:id/cells/:cell_id | edit |
| PUT | /v1/vidsheet/:id/cells/mass_update | edit |
| PATCH | /v1/vidsheet/:id/cells/:cell_id/set_default_user_job | edit |

## Layers

| Method | Path | Phase |
|--------|------|-------|
| POST | /v1/vidsheet/:id/cells/:cell_id/layers | edit |
| GET | /v1/vidsheet/:id/cells/:cell_id/layers/:layer_id | edit |
| PATCH | /v1/vidsheet/:id/cells/:cell_id/layers/:layer_id | edit |
| DELETE | /v1/vidsheet/:id/cells/:cell_id/layers/:layer_id | edit |
| POST | /v1/vidsheet/:id/cells/:cell_id/layers/:layer_id/duplicate | edit |
| PUT | /v1/vidsheet/:id/cells/:cell_id/layers/update_positions | edit |

## Generations

| Method | Path | Phase |
|--------|------|-------|
| POST | /v1/vidsheet/:id/cells/:cell_id/generate | edit |
| POST | /v1/vidsheet/:id/cells/:cell_id/layers/:layer_id/generate | edit |
...
| Method | Path | Phase |
|--------|------|-------|
| GET | /v1/vidsheet/:id/global_variables | edit |
| POST | /v1/vidsheet/:id/import_global_variables | edit |
| GET | /v1/vidsheet/global_variables_template | edit |
...
| Method | Path | Phase |
|--------|------|-------|
| GET | /v1/agents/:agent_id/proof-of-genesis/backups | edit |
| POST | /v1/agents/:agent_id/proof-of-genesis/backups | edit |
| DELETE | /v1/agents/:agent_id/proof-of-genesis/backups/:backup_id | edit |

## Rendering

| Method | Path | Phase |
|--------|------|-------|
| POST | /v1/vidsheet/:id/cells/:cell_id/render | export |
...
| Method | Path | Phase |
|--------|------|-------|
| GET | /v1/credit_balance?agent_id= | export |
| GET | /v1/credit_transactions?agent_id= | export |
| GET | /v1/credit_plans | export |
