...
<Aside>
  Generation endpoints under `/vidsheet/` require the `agent_id` query parameter. The standalone `/generations/` endpoints do not.
</Aside>
...
const response = await fetch(
  "https://api.gen.pro/v1/vidsheet/101/cells/3000/generate?agent_id=42",
  {
    method: "POST",
    headers: {
