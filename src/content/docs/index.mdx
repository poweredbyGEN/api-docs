...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Install the GEN MCP server and drive the entire workflow with natural language — 50+ tools plus guidance and ready-to-run Plays, no glue code."
  />
</CardGrid>
...
- **[MCP Server](https://pypi.org/project/gen-mcp-server/)** — 50+ tools, GEN guidance resources, and the home-screen Plays as prompts, for Claude Code, Cursor, and VS Code (`uvx gen-mcp-server`)
...
`uvx` always runs the latest published `gen-mcp-server` from [PyPI](https://pypi.org/project/gen-mcp-server/) — no manual updates.
